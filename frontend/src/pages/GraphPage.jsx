  ...
  return (
    <div className="max-w-7xl mx-auto space-y-8 animate-fade-in">
      <div className="flex justify-between items-center py-2 border-b border-[var(--border-subtle)]">
        <div>
          <h1 className="text-3xl font-extrabold text-theme-heading tracking-tight">Injury Knowledge Graph</h1>
          <p className="text-sm text-theme-muted font-medium mt-1">Cross-referencing training loads, symptoms and rehab drills</p>
        </div>
        <button 
          onClick={fetchGraphData}
